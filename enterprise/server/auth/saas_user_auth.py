...
from wren.app_server.user_auth.user_auth import AuthType, UserAuth
...
class SaasUserAuth(UserAuth):
    ...
    async def _get_wren_api_key(self) -> str:
        ...
        api_key_store = ApiKeyStore.get_instance()
        wren_api_key = await api_key_store.get_or_create_system_api_key(
            user_id=self.user_id,
            org_id=effective_org_id,
