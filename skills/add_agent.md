...
This agent helps create new microagents in the `.wren/microagents` directory by providing guidance and templates.
...
- Create a markdown file in `.wren/microagents/` with an appropriate name (e.g., `github.md`, `google_workspace.md`)
...
- [Microagents Overview](https://docs.Wren.dev/usage/prompting/microagents-overview)
- [Example GitHub Skill](https://github.com/Wren/Wren/blob/main/skills/github.md)
