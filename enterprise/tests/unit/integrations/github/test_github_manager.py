...
class TestGithubManagerUserNotFound:
    ...
    def github_issue_comment_message(self):
        """Create a sample GitHub issue comment message with an @wren mention."""
        return Message(
            ...
            message={
                ...
                'payload': {
                    ...
                    'comment': {
                        'body': '@wren please help with this issue',
                    },
                },
            },
        )
    ...
    def github_labeled_issue_message(self):
        """Create a sample GitHub labeled issue message (when wren label is added)."""
        return Message(
            source=SourceType.GITHUB,
            message={
                'installation': 12345,
        ...
        return Message(
            ...
            message={
                ...
                'payload': {
                    ...
                    'comment': {
                        'body': '@wren please review this PR',
                    },
                },
            },
        )
    ...
    @patch('integrations.github.github_manager.Auth')
    @patch('integrations.github.github_manager.GithubIntegration')
    async def test_is_job_requested_ignores_wren_bot_sender(
        self,
        mock_github_integration,
        mock_auth,
        mock_token_manager,
        ...
        github_issue_message.message['payload']['comment']['body'] = (
            'Documented upstream changes in @wren/extensions.'
        )
    ...
    @patch('integrations.github.github_manager.Auth')
    @patch('integrations.github.github_manager.GithubIntegration')
    async def test_receive_message_ignores_wren_bot_sender_before_processing(
        self,
        mock_github_integration,
        mock_auth,
        mock_token_manager,
...
class TestGetUserNotFoundMessageIntegration:
    ...
    def test_message_mentions_wren_cloud(self):
    ...
    def test_message_is_friendly_and_informative(self):
        ...
        assert "haven't created an wren account" in message.lower()
