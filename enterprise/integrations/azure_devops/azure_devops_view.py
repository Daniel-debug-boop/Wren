...
from wren.app_server.integrations.azure_devops.azure_devops_service import (
...
from wren.app_server.integrations.service_types import Comment
...
from wren.sdk import TextContent

OH_LABEL, INLINE_OH_LABEL = get_oh_labels(HOST)
OPENHANDS_COMMENT_MARKER = '<!-- wren-azure-devops-resolver -->'


def mark_wren_comment(comment: str) -> str:
    if OPENHANDS_COMMENT_MARKER in comment:
        return comment
    return f'{OPENHANDS_COMMENT_MARKER}\n{comment}'


def _is_wren_comment(comment: str) -> bool:
