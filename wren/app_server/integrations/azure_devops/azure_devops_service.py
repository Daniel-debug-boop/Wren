...
from wren.app_server.integrations.azure_devops.service.branches import (
    AzureDevOpsBranchesMixin,
)
from wren.app_server.integrations.azure_devops.service.features import (
    AzureDevOpsFeaturesMixin,
)
from wren.app_server.integrations.azure_devops.service.prs import (
    AzureDevOpsPRsMixin,
)
from wren.app_server.integrations.azure_devops.service.repos import (
    AzureDevOpsReposMixin,
)
from wren.app_server.integrations.azure_devops.service.resolver import (
    AzureDevOpsResolverMixin,
)
from wren.app_server.integrations.azure_devops.service.webhooks import (
    AzureDevOpsWebhooksMixin,
)
from wren.app_server.integrations.azure_devops.service.work_items import (
    AzureDevOpsWorkItemsMixin,
)
from wren.app_server.integrations.protocols.http_client import HTTPClient
