...
from wren.app_server.utils.llm import MASKED_API_KEY, resolve_llm_base_url
...
class OrgDefaultsSettingsResponse(BaseModel):
    ...
    def from_org(cls, org: Org) -> 'OrgDefaultsSettingsResponse':
        ...
        The SDK now keeps ``wren/`` as the public/stored provider prefix
