...
from wren.app_server.file_store.google_cloud import GoogleCloudFileStore
...
from wren.app_server.file_store.s3 import S3FileStore
...
class TestLocalFileStore(TestCase, _StorageTest):
    def setUp(self):
        ...
        self.temp_dir = tempfile.mkdtemp(prefix='wren_test_')
...
@patch(
    'wren.app_server.file_store.google_cloud.storage.Client',
