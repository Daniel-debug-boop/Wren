...
def test_sensitive_filter_applied_to_handler_catches_child_logger_records():
    ...
    the handler as well as to wren_logger so that child-logger records
    (e.g. wren.app_server.*) are still redacted.
    """
    import io
    ...
    parent = logging.getLogger('wren.test_parent')
    parent.addHandler(handler)
    parent.setLevel(logging.DEBUG)
    parent.propagate = False

    child = logging.getLogger('wren.test_parent.child')
