...
from wren.analytics import get_analytics_service
...
from wren.app_server.settings.llm_profiles import (
...
def _post_merge_llm_fixups(settings: Settings) -> None:
    ...
    rules to :func:`wren.app_server.utils.llm.resolve_llm_base_url` so the
