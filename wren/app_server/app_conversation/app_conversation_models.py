...
from wren.agent_server.utils import OpenHandsUUID, utc_now
from wren.app_server.event_callback.event_callback_models import (
    EventCallbackProcessor,
)
from wren.app_server.integrations.service_types import ProviderType, SuggestedTask
...
class AppConversationStartRequest(OpenHandsModel):
    ...
    mode: str = Field(
        default='code',
        description='Application mode: "code" (default) or "video". '
        'Injects a mode-specific system prompt into the agent context.',
    )
