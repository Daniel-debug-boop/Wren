# Wren FileStore Module

The file store module provides different storage backends for file operations in Wren. This module implements a common interface (`FileStore`) that allows for interchangeable storage backends.
...
```python
from wren.app_server.file_store import get_file_store, LocalFileStore
...
To configure the file store in Wren, use the following configuration options:
