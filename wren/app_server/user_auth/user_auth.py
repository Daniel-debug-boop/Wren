...
#   - V1 application server (in this repo): wren/app_server/
# Unless you are working on deprecation, please avoid extending this legacy file and consult the V1 codepaths above.
# Tag: Legacy-V0
# This module belongs to the old V0 web server. The V1 application server lives under wren/app_server/.
...
class UserAuth(ABC):
    ...
    The class is instantiated via get_impl() in wren.app_server.shared.py.
    """
