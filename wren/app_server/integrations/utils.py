...
from wren.app_server.integrations.forgejo.forgejo_service import ForgejoService
from wren.app_server.integrations.github.github_service import GitHubService
from wren.app_server.integrations.gitlab.gitlab_service import GitLabService
