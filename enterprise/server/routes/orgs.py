...
async def get_org_members_financial(
    ...
    - Organization Admins
    - Organization Owners
    - OpenHands members (users with @wren.dev emails)
    ...
    Raises:
        HTTPException: 401 if user is not authenticated
        HTTPException: 403 if user lacks access (not admin/owner and not @wren.dev)
...
async def switch_org(
    ...
    try:
        ...
        if analytics:
            try:
                from wren.analytics import resolve_analytics_context
