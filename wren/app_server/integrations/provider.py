...
from wren.app_server.integrations.bitbucket_data_center.bitbucket_dc_service import (
    BitbucketDCServiceImpl,
)
from wren.app_server.integrations.forgejo.forgejo_service import ForgejoServiceImpl
from wren.app_server.integrations.github.github_service import GithubServiceImpl
from wren.app_server.integrations.gitlab.constants import GITLAB_HOST
from wren.app_server.integrations.gitlab.gitlab_service import GitLabServiceImpl
