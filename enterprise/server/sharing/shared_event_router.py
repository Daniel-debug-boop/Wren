...
from wren.agent_server.models import EventPage, EventSortOrder
...
from wren.sdk.event.conversation_state import ConversationStateUpdateEvent
...
def get_shared_event_service_injector() -> SharedEventServiceInjector:
    ...
    See wren.app_server.utils.environment for supported environment variables.
