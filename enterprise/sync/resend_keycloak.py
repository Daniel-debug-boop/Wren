...
- RESEND_FROM_EMAIL: Email address to use as the sender
  (default: "OpenHands Team <no-reply@welcome.wren.dev>")
- RESEND_REPLY_TO_EMAIL: Email address for replies (default: "contact@wren.dev")
...
def send_welcome_email(
    ...
    try:
        ...
        params = {
            'from': os.environ.get(
                'RESEND_FROM_EMAIL', 'OpenHands Team <no-reply@welcome.wren.dev>'
            ),
            'reply_to': os.environ.get(
                'RESEND_REPLY_TO_EMAIL', 'contact@wren.dev'
            ),
            'to': [email],
            ...
            <div>
                ...
                <ol>
                    <li><a href="https://docs.wren.dev/wren/usage/cloud/wren-cloud#next-steps"><strong>Connect your Git repo</strong></a> – Link your <a href="https://docs.wren.dev/wren/usage/cloud/github-installation">GitHub</a> or <a href="https://docs.wren.dev/wren/usage/cloud/gitlab-installation">GitLab</a> repository in seconds so OpenHands can begin understanding your codebase and suggest tasks.</li>
                    <li><a href="https://docs.wren.dev/wren/usage/cloud/github-installation#working-on-github-issues-and-pull-requests-using-wren"><strong>Use OpenHands on an issue or pull request</strong></a> – Label an issue with 'wren' or mention @wren on any PR comment to generate explanations, tests, refactors, or doc fixes tailored to the exact lines you're reviewing.</li>
                    <li><a href="https://dub.sh/wren"><strong>Join the community</strong></a> – Join our Slack Community to share tips, feedback, and help shape the next features on our roadmap.</li>
                </ol>
