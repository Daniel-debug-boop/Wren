...
class TestDockerSandboxSpecServiceInjector:
    ...
    @patch('wren.app_server.sandbox.docker_sandbox_spec_service.get_docker_client')
    ...
    def test_get_default_sandbox_specs(self):
        ...
        assert specs[0].id.startswith('ghcr.io/wren/agent-server:')
    ...
    @patch(
        'wren.app_server.sandbox.docker_sandbox_spec_service._global_docker_client',
        None,
    )
    ...
    def test_get_docker_client_reuses_existing_client(
        ...
        import wren.app_server.sandbox.docker_sandbox_spec_service as module
    ...
    @patch('wren.app_server.sandbox.docker_sandbox_spec_service.get_docker_client')
    @patch('wren.app_server.sandbox.docker_sandbox_spec_service._logger')
