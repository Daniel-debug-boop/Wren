...
class TestVerifyExistingKey:
    ...
    @pytest.mark.asyncio
    async def test_verify_existing_key_wren_type_found(self):
    ...
    @pytest.mark.asyncio
    async def test_verify_existing_key_wren_type_not_found(self):
    ...
    @pytest.mark.asyncio
    async def test_verify_existing_key_by_alias_wren_cloud(self):
        ...
        mock_keys = [
            {
                ...
                'key_alias': get_wren_cloud_key_alias(user_id, org_id),
                'team_id': org_id,
                'metadata': None,
            }
        ]
