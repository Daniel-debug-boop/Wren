...
from wren.app_server.secrets.secrets_models import (
    CustomSecretCreate,
    CustomSecretPage,
...
from wren.app_server.utils.models import EditResponse
...
async def search_custom_secrets(
    ...
    In SaaS mode, includes the system-generated WREN_API_KEY which cannot be deleted.
