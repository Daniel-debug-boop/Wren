...
class OpenhandsPR(Base):
    ...
    wren_helped_author: Mapped[bool | None] = mapped_column(nullable=True)
    num_wren_commits: Mapped[int | None] = mapped_column(nullable=True)
    num_wren_review_comments: Mapped[int | None] = mapped_column(nullable=True)
    num_wren_general_comments: Mapped[int | None] = mapped_column(nullable=True)
