 ...
 * Dark theme with amber accent. Bento grid for features.
 */
...
export default function HomePage() {
  return (
    <div style={{ background: "var(--bg-deep)" }}>
      ...
      >
        <div className="mx-auto flex h-12 max-w-6xl items-center justify-between px-6">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="#how-it-works" className="text-xs" style={{ color: "var(--text-tertiary)" }}>
              How It Works
            </a>
            <a href="https://github.com/Daniel-debug-boop/Wren" target="_blank" rel="noopener noreferrer" className="text-xs" style={{ color: "var(--text-tertiary)" }}>
              GitHub
            </a>
          </div>

          <Link to="/workspace" className="btn-primary" style={{ height: 32, fontSize: 12, padding: "0 16px" }}>
            Open Workspace
          </Link>
        </div>
      </nav>
      ...
      {/* ── Hero ── */}
      <section className="mx-auto flex min-h-[70vh] max-w-6xl items-center px-6 pt-24 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
          <div>
            ...
            <p className="mt-5 text-sm max-w-md leading-relaxed" style={{ color: "var(--text-secondary)" }}>
              Wren is a self-hosted AI engineering platform. Describe what you want,
              and the AI pipeline architects, plans, writes, and reviews the code.
              Connect your own LLM. Keep your data private.
            </p>
            ...
            <div className="mt-10 flex gap-8">
              <div>
                ...
                <div className="text-xs mt-0.5" style={{ color: "var(--text-tertiary)" }}>Pipeline stages</div>
              </div>
              <div>
                <div className="text-lg font-semibold" style={{ color: "var(--text-primary)" }}>16+</div>
                <div className="text-xs mt-0.5" style={{ color: "var(--text-tertiary)" }}>Languages</div>
              </div>
              <div>
          ...
          <div className="hidden lg:block">
            <div className="mockup-frame">
              <div className="mockup-header">
                ...
                <span className="text-[10px] ml-2" style={{ color: "var(--text-muted)" }}>wren -- workspace</span>
              ...
              <div className="mockup-body">
                ...
                <div className="mockup-editor">
                  <div className="mockup-line mockup-line-highlight">// app.py</div>
                  <div className="mockup-line" style={{ marginTop: 8 }}>&nbsp;</div>
                  <div className="mockup-line"><span style={{ color: "var(--text-muted)" }}>from</span> <span style={{ color: "#06b6d4" }}>fastapi</span> <span style={{ color: "var(--text-muted)" }}>import</span> <span style={{ color: "#22c55e" }}>FastAPI</span></div>
                  <div className="mockup-line"><span style={{ color: "var(--accent)" }}>app</span> = <span style={{ color: "#22c55e" }}>FastAPI</span>()</div>
                  <div className="mockup-line" style={{ marginTop: 8 }}>&nbsp;</div>
                  <div className="mockup-line"><span style={{ color: "var(--text-muted)" }}>@app.</span><span style={{ color: "#f59e0b" }}>get</span><span style={{ color: "var(--text-muted)" }}>(</span><span style={{ color: "#22c55e" }}>"/"</span><span style={{ color: "var(--text-muted)" }}>)</span></div>
                  <div className="mockup-line"><span style={{ color: "var(--text-muted)" }}>async def</span> <span style={{ color: "#3b82f6" }}>root</span>():</div>
                  <div className="mockup-line">&nbsp;&nbsp;<span style={{ color: "var(--text-muted)" }}>return</span> {<span style={{ color: "#22c55e" }}>{"message"}</span>: <span style={{ color: "#22c55e" }}>{"Hello, World!"}</span>}</div>
                </div>
      ...
      <section id="features" className="mx-auto max-w-6xl px-6 py-20">
        <div className="text-center mb-12">
          ...
          <p className="text-sm mt-2 max-w-lg mx-auto" style={{ color: "var(--text-tertiary)" }}>
            Everything you need to go from idea to running code, in a single self-hosted platform.
          </p>
        </div>
      ...
      <section id="how-it-works" className="mx-auto max-w-6xl px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          {[
            { step: "1", title: "Describe", desc: "Tell Wren what you want to build in plain English" },
            { step: "2", title: "Architect", desc: "AI designs the system architecture and component layout" },
            { step: "3", title: "Generate", desc: "Code is written, reviewed, and saved as real files" },
            { step: "4", title: "Run", desc: "Execute your project in the built-in terminal and editor" },
          ].map((s) => (
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={t.name} className="bento-card text-center py-6">
