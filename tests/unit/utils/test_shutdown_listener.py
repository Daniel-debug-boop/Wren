...
from wren.app_server.utils import shutdown_listener
from wren.app_server.utils.shutdown_listener import (
...
def test_signal_handler_calls_listeners():
    ...
    with patch('wren.app_server.utils.shutdown_listener.signal', mock_signal):
