...
class BitbucketDCManager(Manager[BitbucketDCViewType]):
    ...
    def _posting_service(self):
        ...
        App's ``wren[bot]`` identity. ``receive_message`` gates on the bot
    ...
    async def receive_message(self, message: Message) -> None:
        ...
        # we'd risk re-firing the webhook on our own "@wren" comment, so skip
        ...
        # the bot PAT and can contain "@wren"; without this guard it would
