...
def slack_new_conversation_view(mock_slack_user, mock_user_auth):
    ...
    return SlackNewConversationView(
        ...
        slack_to_wren_user=mock_slack_user,
...
class TestPausedSandboxResumption:
    ...
    @patch('wren.app_server.config.get_sandbox_service')
    @patch('wren.app_server.config.get_app_conversation_info_service')
    @patch('wren.app_server.config.get_httpx_client')
    @patch('wren.app_server.event_callback.util.ensure_running_sandbox')
    @patch('wren.app_server.event_callback.util.get_agent_server_url_from_sandbox')
    @patch.object(
