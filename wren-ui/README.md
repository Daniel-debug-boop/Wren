...
```tsx
import { Button, Typography } from "@wren/ui";
import "@wren/ui/styles";
...
# Replace `path/to/wren-ui-x.x.x.tgz` with the actual path to the generated `.tgz` file.
npm install path/to/wren-ui-x.x.x.tgz
```
