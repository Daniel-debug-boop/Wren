...
class SlackManager(Manager[SlackViewInterface]):
    ...
    async def authenticate_user(
        ...
        async with a_session_maker() as session:
            ...
            # slack_view.slack_to_wren_user = slack_user # attach user auth info to view
        ...
        if slack_user:
            ...
            # slack_view.saas_user_auth = await self._get_user_auth(slack_view.slack_to_wren_user.keycloak_user_id)
    ...
    async def _try_verify_inferred_repo(
        ...
        """
        user = slack_view.slack_to_wren_user
    ...
    async def start_job(self, slack_view: SlackViewInterface) -> None:
        ...
        try:
            msg_info = None
            user_info = slack_view.slack_to_wren_user
            try:
                logger.info(
