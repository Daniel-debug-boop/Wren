...
from wren.app_server.config_api.config_models import (
    LLMModelPage,
    ProviderPage,
)
...
from wren.app_server.config_api.llm_model_service import LLMModelService
...
class TestToLLMModelsHiddenCanonical:
    ...
    def test_canonical_set_only_on_mapped_hidden_models(self):
        response = ModelsResponse(
            models=['wren/real-model'],
            verified_models=['real-model'],
            verified_providers=['wren'],
            default_model='wren/real-model',
            hidden_models=['wren/legacy-alias', 'wren/untagged-alias'],
            hidden_model_canonicals={'wren/legacy-alias': 'wren/real-model'},
        )
