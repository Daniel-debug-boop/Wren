...
This document traces the complete data flow for launching plugins in Wren, from the source marketplace through to agent execution. Each section shows the exact endpoints, payloads, and transformations.
...
**Source**: A GitHub repository (e.g., `github.com/Wren/plugin-marketplace`)
...
```json
{
  "name": "Wren Plugin Marketplace",
  "owner": {
    "name": "Wren",
    "email": "team@all-hands.dev"
  },
  "metadata": {
    "description": "Official Wren plugin marketplace",
    "pluginRoot": "plugins"
  },
  "plugins": [
    {
      "name": "city-weather",
      "source": "github:jpshackelford/wren-sample-plugins",
      "ref": "main",
  ...
  "plugins": [
    {
      ...
      "source": {
        "source": "github",
        "repo": "jpshackelford/wren-sample-plugins",
        "ref": "main",
        "repo_path": "plugins/city-weather"
      },
      "tags": ["weather", "utility"]
...
**Launch URL**:
```
https://app.wren.ai/launch?plugins=BASE64&message=%2Fcity-weather%3Anow
```
...
## Step 4: Wren Frontend (`/launch` Route)

**Route**: `/launch?plugins=BASE64&message=/city-weather:now`

[PR #12699](https://github.com/Wren/Wren/pull/12699)
...
## Step 5: Wren App Server

**Endpoint**: `POST /api/v1/app-conversations`

[PR #12338](https://github.com/Wren/Wren/pull/12338)
...
2. **Convert PluginSpec → SDK PluginSource** (parameters are DROPPED):
   ...
   sdk_plugins = [
       PluginSource(
           source=p.source,      # "github:jpshackelford/wren-sample-plugins"
           ref=p.ref,            # "main"
...
[SDK PR #1651](https://github.com/Wren/software-agent-sdk/pull/1651)
...
[SDK PR #1647](https://github.com/Wren/software-agent-sdk/pull/1647)
...
| 4 | Wren Frontend | URL query params | API call: `plugins` (with user values) + `message` (unchanged slash command) |
...
```
┌─────────────────────┐     ┌─────────────────────┐     ┌─────────────────────┐
│  Plugin Directory   │     │  Wren Frontend │     │    App Server       │
│                     │     │                     │     │                     │
...
- [Wren PR #12338](https://github.com/Wren/Wren/pull/12338) - App server plugin support
- [Wren PR #12699](https://github.com/Wren/Wren/pull/12699) - Frontend `/launch` route
- [SDK PR #1651](https://github.com/Wren/software-agent-sdk/pull/1651) - Agent server plugin loading
- [SDK PR #1647](https://github.com/Wren/software-agent-sdk/pull/1647) - Plugin.fetch() for remote plugin fetching
- [SDK PR #2230](https://github.com/Wren/software-agent-sdk/pull/2230) - entry_command field definition
- [Plugin Directory PR #84](https://github.com/Wren/plugin-directory/pull/84) - entry_command support in plugin directory
