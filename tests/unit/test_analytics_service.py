...
from wren.analytics import (
    AnalyticsService,
    get_analytics_service,
    init_analytics_service,
)
from wren.analytics.analytics_constants import (
...
from wren.analytics.analytics_service import AnalyticsService as DirectService
from wren.analytics.oss_install_id import get_or_create_install_id
...
def reset_singleton():
    ...
    import wren.analytics as analytics_module
...
def mock_posthog():
    ...
    with patch('wren.analytics.analytics_service.Posthog', autospec=True) as MockClass:
