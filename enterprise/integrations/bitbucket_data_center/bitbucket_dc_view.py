...
from wren.app_server.integrations.provider import (
    PROVIDER_TOKEN_TYPE,
    ProviderType,
)
...
# editing an existing @wren comment must not start a second job.
...
class BitbucketDCFactory:
    ...
    contains a case-insensitive mention of the configured ``@wren``
