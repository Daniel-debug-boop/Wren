...
def upgrade() -> None:
    ...
    # Seed with current wren provider models
    models = [
        ('claude-opus-4-5-20251101', 'wren'),
        ('claude-sonnet-4-5-20250929', 'wren'),
        ('gpt-5.2-codex', 'wren'),
        ('gpt-5.2', 'wren'),
        ('minimax-m2.5', 'wren'),
        ('gemini-3-pro-preview', 'wren'),
        ('gemini-3-flash-preview', 'wren'),
        ('deepseek-chat', 'wren'),
        ('devstral-medium-2512', 'wren'),
        ('kimi-k2-0711-preview', 'wren'),
        ('qwen3-coder-480b', 'wren'),
    ]
